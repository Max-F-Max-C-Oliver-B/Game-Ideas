...
def Terre_suppression(vies, météorites_liste_up, météorites_liste_left):
    """disparition du Terre et d'un météorite si contact"""
...
def update():
    ...
    global Terre_x, Terre_y, météorites_liste_up, vies, explosions_liste
    ...
    #vies = Terre_suppression(vies, météorites_liste_up, météorites_liste_left)
